...
public class Employe {
    ...
    public String toString(){
        ...
        employeStr += "=> Nombre de jours du  travail                :"+getNbr_jrs_travail()+" jours/semaine \n";
        employeStr += "=> Nombre de heures du  travail                :"+getNbr_hr_travail()+" heures/jour \n";
        employeStr += "=> Prix de l'heure du  travail                :"+getPrix_heure()+" Dh \n";
        employeStr += "=> Nombre de jours d'absence                 :"+getNbr_jrs_absence()+" jours/mois \n";
        employeStr += "------------------------------------------------------         \n";
        employeStr += "=> Salaire                  :"
